...
export const ExpensesView: React.FC<ExpensesViewProps> = ({ onOpenAddModal, onEditExpense }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-slate-900">Monthly Expense Categorization</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm hover-lift"
          >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2 bg-white border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
            ...
            <table className="w-full text-sm" role="table">
              <thead>
                <tr className="border-b border-slate-100">
                  ...
                  <th className="text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wider py-3 px-5 hidden sm:table-cell">Category</th>
                  <th className="text-left text-[10px] font-semibold text-slate-400 uppercase tracking-wider py-3 px-5 hidden md:table-cell">Method</th>
              ...
              <AnimatePresence mode="popLayout">
                <motion.tbody className="divide-y divide-slate-50">
                  {monthlyFilteredExpenses.map((rec, i) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-5 text-xs text-slate-500 whitespace-nowrap hidden sm:table-cell">
                        <span className="inline-flex items-center gap-1">
                          <span>{CATEGORY_EMOJI[rec.category] || '📦'}</span>
                          <span>{rec.category}</span>
                        </span>
                      </td>
                      <td className="py-3 px-5 text-xs text-slate-400 whitespace-nowrap hidden md:table-cell">
                        {rec.payment_method}
                      </td>
                        ...
                        <div className="flex items-center justify-end gap-1">
                          {rec.receipt_url && (
                            <motion.button
                              ...
                              className="p-1.5 text-slate-300 hover:text-blue-500 rounded-md hover:bg-blue-50 transition-colors"
                              title="View Receipt"
        ...
        {previewReceipt && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl p-4 max-w-lg w-full relative shadow-2xl"
